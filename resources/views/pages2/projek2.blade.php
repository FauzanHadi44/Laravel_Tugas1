...
<body class="pt-16 bg-[url('/profil/1bg.jpg')] bg-cover bg-center bg-fixed bg-no-repeat">
            ...
            <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-stone-400 divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700" id="language-dropdown-menu">
                    <ul class="py-2 font-medium" role="none">
                        <li>
                            <a href="{{ route('projek') }}" class="block px-4 py-2 text-sm text-gray-800 hover:bg-stone-300 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
    ...
    <div class="no-file-found flex flex-col items-center justify-center py-50 px-4 text-center dark:bg-gray-800 rounded-lg">
        ...
        <h3 class="text-xl font-medium mt-4 text-gray-700 dark:text-gray-200">Berkas tidak ditemukan</h3>
        <p class="text-gray-500 dark:text-gray-400 mt-2">
            Berkas yang Anda cari tidak dapat ditemukan.
        </p>
    </div>
    ...
    <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-stone-400 border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            ...
            <a href="{{ route('kontak2') }}" data-tooltip-target="tooltip-wallet" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-stone-300 dark:hover:bg-gray-800 group">
            ...
            <a href="{{ route('projek2') }}" data-tooltip-target="tooltip-settings" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-stone-300 dark:hover:bg-gray-800 group bg-stone-300" aria-current="page">
