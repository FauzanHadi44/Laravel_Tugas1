            ...
            <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 md:place-items-center md:gap-12 sm:place-items-center">
                <div>
                    ...
                    <div class="mt-4 flex sm:mt-6">
                        <a href="{{ route('kontak') }}" class="inline-block rounded-sm bg-stone-300 px-8 py-3 text-sm font-medium text-grey-700 transition hover:bg-stone-400 hover:rotate-2 focus:ring-3 focus:outline-hidden">
                            Contact Me                    
                        </a>
