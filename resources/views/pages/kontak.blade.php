...
<body class="pt-16 bg-[url('/profil/1bg.jpg')] bg-cover bg-center bg-fixed bg-no-repeat">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-stone-300 dark:hover:bg-gray-700 dark:hover:text-white">
                    <span class="text-2xl font-bold text-gray-900 dark:text-white font-mono">ID</span>
                </button>
                <!-- Dropdown -->
                <div class="z-50 hidden my-4 text-base list-none bg-stone-400 divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700" id="language-dropdown-menu">
                    <ul class="py-2 font-medium" role="none">
                        <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-800 hover:bg-stone-300 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                <div class="inline-flex items-center">
                                    <span class="text-2xl font-bold text-gray-900 dark:text-white font-mono">US</span>
                                </div>
                            </a>
                        </li>
                    </ul>
    ...
    <section>
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
                <h1 class="text-3xl font-bold text-gray-900 sm:text-3xl mt-8">Contacts</h1>
                <p class="mt-2 max-w-md text-gray-500">
                    If you're interested in collaborating, have any questions, or simply want to discuss technology and web development, feel free to reach out to me through my social media.
                </p>
            </header>
    ...
    <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-stone-400 border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            ...
            <a href="{{ route('kontak') }}" data-tooltip-target="tooltip-wallet" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-stone-300 dark:hover:bg-gray-800 group bg-stone-300" aria-current="page">
